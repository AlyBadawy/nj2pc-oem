...
export function IncidentMessageLogs() {
  const { user } = useAuth()
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <h1 className="text-2xl font-semibold">Message Log (ICS-213)</h1>
      </div>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle className="text-base">
            Entries
            <span className="ml-2 text-muted-foreground font-normal text-sm">({logs?.length ?? 0})</span>
          </CardTitle>
          {!isClosed && (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            <div className="grid grid-cols-2 gap-3">
              <div className="flex flex-col gap-1.5">
                ...
                <Select value={form.operatorId} onValueChange={(value) => setForm({ ...form, operatorId: value })}>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <Select value={form.toOperatorId} onValueChange={(value) => setForm({ ...form, toOperatorId: value })}>
