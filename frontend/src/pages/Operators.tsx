...
import type { Operator, OperatorSummary } from '@/lib/types'
...
export function Operators() {
  ...
  const { data: operatorSummaries, isLoading: summariesLoading } = useQuery({
    queryKey: ['operators', 'summary'],
    queryFn: async () => (await api.get<OperatorSummary[]>('/api/operators')).data,
    enabled: isRestricted,
  })
