...
public class Ics205PdfService {
    ...
    private static final Font TITLE_FONT = FontFactory.getFont(FontFactory.HELVETICA_BOLD, 16, INK);
    ...
    private Paragraph buildFooter(CommunicationPlan plan) {
        Paragraph footer = new Paragraph(
                "ICS 205  |  " + plan.getName() + "  |  v" + plan.getVersion() + "  |  Generated by NJ2PC-OEM",
                SMALL_ITALIC_FONT);
